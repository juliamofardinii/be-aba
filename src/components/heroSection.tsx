...
export default function HeroSection() {
  return (
    <div className="relative grid items-center grid-cols-1 md:grid-cols-[1fr_1fr] gap-10  text-center md:text-left  bg-[var(--color-background)] p-10">
      <div className="space-y-8 font-sans text-center w-full md:max-w-[500px] lg:max-w-[550px] xl:max-w-[800px] mx-auto">
        <h1 className="text-[28px] md:text-[36px] lg:text-[38px] xl:text-[45px] font-bold leading-tight text-left text-[var(--color-primary)]">
          Cuidar com propósito, desenvolver com{" "}
          <span className="text-[#FFA500] font-bold">amor e atenção</span>
        </h1>
        <p className="text-[14px] md:text-[16px] xl:text-[20px] text-neutral-700  text-left ">
        ...
        <Button
          className="mt-10 cursor-pointer bg-[#FFC83D] hover:bg-[#e0b232] text-white px-8 py-4 rounded-md transition lg:px-12 lg:py-6 md:px-10 md:py-6 xl:px-15 xl:py-8"
          size={"lg"}
        >
